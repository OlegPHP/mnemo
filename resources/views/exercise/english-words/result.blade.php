        ...
        <div class="overflow-x-auto">
            <table class="w-full border-collapse text-left">
                ...
                <tr class="bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-white">
                    <th class="px-4 py-2 border-b border-neutral-300 dark:border-neutral-700">Слово</th>
                    ...
                    <th class="px-4 py-2 border-b border-neutral-300 dark:border-neutral-700">Перевод</th>
                </tr>
                </thead>
                <tbody>
                @foreach($details as $detail)
                    <tr class="@if($loop->even) bg-neutral-50 dark:bg-neutral-900 @else bg-neutral-100 dark:bg-neutral-800 @endif">
                        <td class="px-4 py-2 border-b border-neutral-300 dark:border-neutral-700 font-medium">{{$detail['en']}}</td>
                        ...
                        <td class="px-4 py-2 border-b border-neutral-300 dark:border-neutral-700">{{$detail['ru']}}</td>
                    </tr>
                @endforeach
                </tbody>
            </table>
