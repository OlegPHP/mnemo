<x-layouts.app :title="'Мнемотехники — результат упражнения'">
            ...
            <table class="w-full border-collapse text-left">
                ...
                @foreach($details as $detail)
                    <tr class="@if($loop->even) bg-neutral-50 dark:bg-neutral-900 @else bg-neutral-100 dark:bg-neutral-800 @endif">
                        ...
                        <td class="px-4 py-2 border-b border-neutral-300 dark:border-neutral-700">{{$detail['word']}}</td>
                    </tr>
                @endforeach
                </tbody>
            </table>
    ...
    <div class="text-center mt-6">
        <flux:button href="{{ route('exercises.list.start', ['exercise' => $exercise->slug]) }}" variant="primary" color="yellow">
            Пройти снова
        </flux:button>
    </div>
</x-layouts.app>
